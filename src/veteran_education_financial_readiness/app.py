...
def main():
    ...
    **New GI/VR&E Bill helpers**
    ...
    forecast_end = st.sidebar.date_input(
        ...
        value=min(forecast_start + timedelta(days=180), max_end),
    ...
    add_term_block("Spring", default_enabled=True,  default_start_offset_days=60,  default_length_days=90,  key_prefix="spring")
    add_term_block("Summer", default_enabled=False, default_start_offset_days=150, default_length_days=60,  key_prefix="summer")
    add_term_block("Fall",   default_enabled=True,  default_start_offset_days=240, default_length_days=90,  key_prefix="fall")
